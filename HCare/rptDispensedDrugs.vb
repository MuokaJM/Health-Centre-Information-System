...
Public Class rptDispensedDrugs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptDispensedDrugs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDispensedDrugs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDispensedDrugs = New rptDispensedDrugs()
        rpt.Site = Me.Site
        Return rpt
    End Function
