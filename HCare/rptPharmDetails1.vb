...
Public Class rptPharmDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptPharmDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPharmDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPharmDetails = New rptPharmDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
