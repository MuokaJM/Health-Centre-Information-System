...
Public Class rptDailyCollections
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDailyCollections.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptDailyCollections.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyCollections
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyCollections = New rptDailyCollections()
        rpt.Site = Me.Site
        Return rpt
    End Function
