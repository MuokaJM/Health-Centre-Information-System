...
Public Class rptPharmRequest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptPharmRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPharmRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPharmRequest = New rptPharmRequest()
        rpt.Site = Me.Site
        Return rpt
    End Function
