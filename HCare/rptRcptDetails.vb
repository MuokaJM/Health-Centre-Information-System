...
Public Class rptRcptDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptRcptDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRcptDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRcptDetails = New rptRcptDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
