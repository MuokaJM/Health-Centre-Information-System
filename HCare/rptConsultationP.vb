...
Public Class rptConsultationP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptConsultationP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsultationP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsultationP = New rptConsultationP()
        rpt.Site = Me.Site
        Return rpt
    End Function
