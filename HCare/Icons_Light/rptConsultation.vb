...
Public Class rptConsultation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptConsultation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptConsultation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptConsultation = New rptConsultation()
        rpt.Site = Me.Site
        Return rpt
    End Function
