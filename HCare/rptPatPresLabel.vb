...
Public Class rptPatPresLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptPatPresLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPatPresLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatPresLabel = New rptPatPresLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
