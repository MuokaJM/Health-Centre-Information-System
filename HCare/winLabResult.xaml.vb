    ...
    Private Sub btnPrint_Click(sender As Object, e As RoutedEventArgs) Handles btnPrint.Click
        ...
        If txtRNo.Text <> "" Then
            ...
            With rsLabRep
                ...
                .Open("SELECT * FROM tblLab WHERE LsNo=" & Val(txtRNo.Text), MainWin.cnHCIS, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockReadOnly)
                If .RecordCount > 0 Then
                    ...
                    rptLabRep.RecordSelectionFormula = "{tblPatient.PNo} =" & iPNo & " and {tblLab.LsNo} =" & lnLSNo & "" ' and {tblPayment.PYNo} =" & lnPYNO & ""
                    rptLabRep.Refresh()
