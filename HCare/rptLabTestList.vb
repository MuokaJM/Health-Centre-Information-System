...
Public Class rptLabTestList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HCare.rptLabTestList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLabTestList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLabTestList = New rptLabTestList()
        rpt.Site = Me.Site
        Return rpt
    End Function
